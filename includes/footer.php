    ...
    <div class="container mx-auto max-w-7xl px-4 py-16 sm:py-24">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-12">
            ...
            <div class="md:col-span-2 md:ml-auto ">
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-[#EDEDED] hover:text-white transition-colors">Profil</a></li>
                    <li><a href="#" class="text-[#EDEDED] hover:text-white transition-colors">Arsip</a></li>
                    <li><a href="#" class="text-[#EDEDED] hover:text-white transition-colors">Galeri</a></li>
                    <li><a href="#" class="text-[#EDEDED] hover:text-white transition-colors">Layanan</a></li>
                </ul>
            </div>
